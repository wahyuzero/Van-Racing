export const faqData = [
  ...
  },
  {
    id: 2,
    category: 'Produk',
    question: 'Apa perbedaan antara Full System dan Slip On?',
    answer: 'Full System mengganti seluruh sistem knalpot dari header hingga ujung, memberikan peningkatan performa maksimal. Slip On hanya mengganti bagian belakang knalpot (muffler), lebih mudah dipasang dan harga lebih terjangkau. Full System cocok untuk performa maksimal, sedangkan Slip On cocok untuk upgrade suara dengan budget terbatas.'
  },
  {
    id: 3,
    category: 'Produk',
    question: 'Bagaimana cara memilih tipe suara yang tepat?',
    answer: 'Kami menyediakan 3 pilihan karakter suara: Silent Racing (cocok untuk harian, tidak terlalu berisik), Medium Racing (keseimbangan antara performa dan kenyamanan), dan Racing Loud (suara gahar untuk track day). Pilih sesuai kebutuhan dan preferensi Anda. Anda juga bisa mendengar sample suara di galeri kami.'
  },
  {
    id: 4,
    category: 'Pemesanan',
  ...
  },
  {
    id: 5,
    category: 'Pemesanan',
    question: 'Berapa lama waktu pengerjaan untuk custom order?',
    answer: 'Waktu pengerjaan custom order bervariasi tergantung kompleksitas: Slip On custom: 3-5 hari kerja, Full System custom: 7-10 hari kerja, Desain khusus dengan modifikasi kompleks: 10-14 hari kerja. Waktu ini belum termasuk pengiriman. Kami akan memberikan estimasi yang lebih akurat setelah konsultasi detail.'
  },
  {
    id: 6,
    category: 'Pemesanan',
    question: 'Apakah bisa COD (Cash on Delivery)?',
    answer: 'Untuk saat ini kami belum melayani COD. Pembayaran dilakukan di muka melalui transfer bank atau e-wallet. Hal ini untuk memastikan kualitas layanan dan keamanan transaksi. Kami memberikan garansi uang kembali jika produk tidak sesuai atau mengalami kerusakan dalam pengiriman.'
  },
  {
    id: 7,
    category: 'Pengiriman',
  ...
  },
  {
    id: 8,
    category: 'Pengiriman',
    question: 'Berapa ongkos kirim dan berapa lama sampai?',
    answer: 'Ongkos kirim dihitung berdasarkan berat produk dan tujuan pengiriman. Estimasi waktu: Jabodetabek 1-2 hari, Jawa 2-3 hari, Luar Jawa 3-5 hari. Kami akan memberikan informasi detail ongkir dan estimasi waktu saat konfirmasi pemesanan. Gratis ongkir untuk pembelian di atas Rp 2.000.000.'
  },
  {
    id: 9,
    category: 'Garansi',
  ...
  },
  {
    ...
    answer: 'Untuk area Jabodetabek, kami menyediakan layanan pemasangan dengan biaya tambahan. Untuk luar area, kami memberikan panduan pemasangan detail dan video tutorial. Kami juga bisa merekomendasikan bengkel partner di kota Anda. Pemasangan oleh teknisi berpengalaman sangat disarankan untuk hasil optimal.'
  },
  {
    id: 12,
    category: 'Pemasangan',
  ...
  },
  {
    id: 14,
    category: 'Perawatan',
    question: 'Knalpot saya mulai kusam, bagaimana cara mengkilapkannya kembali?',
    answer: 'Untuk mengembalikan kilap knalpot stainless steel: 1) Bersihkan dengan air hangat dan sabun, 2) Gunakan pembersih stainless steel atau pasta gigi, 3) Gosok searah serat stainless dengan kain halus, 4) Bilas dan keringkan dengan lap bersih, 5) Aplikasikan wax khusus stainless jika perlu. Hindari pembersih yang mengandung klorin atau asam kuat.'
  },
  {
    id: 15,
    category: 'Teknis',
